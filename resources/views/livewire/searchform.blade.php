    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div class="grid grid-cols-2 gap-2 border border-gray-200 p-2 rounded">
            <div class="flex border border-[#f84525] rounded bg-white items-center p-2 ">
                ...
                <input type="text" wire:model.live.debounce="naam" placeholder="Naam"
            ...
            <div class="flex border border-[#f84525] rounded bg-white items-center p-2 ">
                ...
                <input type="text" wire:model.live.debounce="telefoon" placeholder="Telefoon"
                    class="bg-white max-w-full focus:outline-none text-gray-700"/>
            </div>
        </div>
        <div class="grid grid-cols-2 gap-2 border border-gray-200 p-2 rounded">
            <div class="flex border border-[#f84525] rounded bg-white items-center p-2 ">
                ...
                <select wire:model.live.debounce="provincie" name="" id="" class="bg-white w-full focus:outline-none text-gray-700">
            ...
            <div class="flex border border-[#f84525] rounded bg-white items-center p-2 ">
                <svg  class="fill-current text-gray-800 mr-2 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                    ...
                    <select wire:model.live.debounce="stad" name="" id="" class="bg-white w-full focus:outline-none text-gray-700">
