<x-guest-layout>
  ...
  <section class="py-24 border border-b-[#f84525] border-b-8 flex items-center justify-center h-1/2 w-screen bg-cover relative" style="background-image: url('img/slider-kat-1.jpg');">
    ...
    <!-- Content Container -->
    <div class="flex mx-auto relative z-10 mt-24">
        <div class="text-center">
            <p class="text-lg font-medium text-white bg-[#f84525] rounded-3xl">Contact Ons</p>
            <h1 class="text-[3.5rem] font-bold leading-[4rem] tracking-tight text-white">Heb je vragen?</h1>
            <p class="mt-3 text-lg leading-relaxed text-slate-400">Voor meer informatie kun je ons een bericht sturen.</p>
        </div>
  </div>
</section>
